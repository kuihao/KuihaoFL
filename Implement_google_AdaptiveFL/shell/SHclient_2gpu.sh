...
sleep 2s
screen -S client-3 -dm bash -c 'python client.py -c 3 --gpu 1;echo "**end of file4**";$SHELL'
sleep 2s
screen -S client-4 -dm bash -c 'python client.py -c 4 --gpu 1;echo "**end of file5**";$SHELL'
sleep 2s
...
sleep 2s
screen -S client-8 -dm bash -c 'python client.py -c 8 --gpu 1;echo "**end of file9**";$SHELL'
sleep 2s
screen -S client-9 -dm bash -c 'python client.py -c 9 --gpu 1;echo "**end of file10**";$SHELL'