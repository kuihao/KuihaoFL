...
screen -S FL-server -m bash -c 'python centralize_learning_fl_simulation.py -m 0 -n NewCode_200round_centro_cifar100_noniid_resnet18_fedyogi;echo "**end of file**";$SHELL'
