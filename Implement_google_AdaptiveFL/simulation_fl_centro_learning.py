...
HyperSet_local_eta = pow(10,(-3/2)) #1e-1
...
HyperSet_every_round_client_number = 500
HyperSet_every_round_client_number_test = 100
HyperSet_round = 100
...
SampleClientID_test_np = Simulation_DynamicClientSample( 
                              training_client_number=HyperSet_every_round_client_number_test, 
...
Clients_DataSize_test_np = np.zeros([HyperSet_every_round_client_number_test])
Clients_Results_test_list = [{}]*HyperSet_every_round_client_number_test
...
for rnd in range(HyperSet_round):
  ...
  # Client Train
  for client_i in range(HyperSet_all_connect_client_number):
    # get client id
  ...
  # Client Test
  for client_i in range(HyperSet_all_connect_test_client_number):
    # get client id
